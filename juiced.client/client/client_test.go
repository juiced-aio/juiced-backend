...
var client, _ = NewClient(utls.HelloChrome_83) // cannot throw an error because there is no proxy
...
func TestClient_HTTP2(t *testing.T) {
	...
	req, _ := http.NewRequest("GET", "https://ezdiscord.xyz/fingerprint", nil)
