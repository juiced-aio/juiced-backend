...
// 	if ok {
// 		taskGroupPtr, err := stores.GetTaskGroup(groupID)
// 		if err == nil {
...
// 		}
// 	} else {
// 		errorsList = append(errorsList, errors.MissingParameterError+"GroupID")
// 	}

// 	result := &responses.TaskGroupResponse{Success: true, Data: []entities.TaskGroup{taskGroup}}
// 	if len(errorsList) > 0 {
// 		response.WriteHeader(http.StatusBadRequest)
// 		result = &responses.TaskGroupResponse{Errors: errorsList}
// 	}
...
// 		data = append(data, *taskGroups[i])
// 	}

// 	result := &responses.TaskGroupResponse{Success: true, Data: data}
// 	if len(errorsList) > 0 {
// 		response.WriteHeader(http.StatusBadRequest)
// 		result = &responses.TaskGroupResponse{Errors: errorsList}
// 	}
...
// 	if err == nil {
// 		request := requests.CreateTaskGroupRequest{}
// 		err = json.Unmarshal(body, &request)
// 		if err == nil {
// 			requestPtr := &request
// 			err = requests.ValidateCreateTaskGroupRequest(requestPtr)
// 			if err == nil {
// 				request = *requestPtr
// 				taskGroup = entities.TaskGroup{
// 					Name:     request.Name,
...
// 				}
// 			} else {
// 				errorsList = append(errorsList, errors.BadRequestError+err.Error())
// 			}
// 		} else {
// 			errorsList = append(errorsList, errors.UnmarshalError+err.Error())
// 		}
// 	} else {
