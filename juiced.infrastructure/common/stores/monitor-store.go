...
// 	Monitors map[string]*base.Monitor
...
// 		if _, ok := monitorStore.Monitors[monitor.GroupID]; ok && !monitor.UpdateMonitor {
// 			return nil
// 		}
...
// 		pokemonCenterMonitor, err := base.CreateRetailerMonitor(monitor.MonitorRetailer, monitor, proxyGroup, monitorStore.EventBus, monitor.PokemonCenterMonitorInfo.Monitors)
// 		if err != nil {
// 			return e.New(errors.CreateMonitorError + err.Error())
// 		}
// 		monitorStore.Monitors[monitor.GroupID] = &pokemonCenterMonitor
...
// 	if baseMonitor, ok := monitorStore.Monitors[monitor.GroupID]; ok {
// 		monitorInfo := baseMonitor.GetMonitorInfo()
// 		monitorInfo.StopFlag = false
// 		go monitorStore.Monitors[monitor.GroupID].RunMonitor()
// 	}
...
// 		monitorInfo := baseMonitor.GetMonitorInfo()
// 		if monitorInfo == nil {
// 			return e.New("monitor info nil pointer")
// 		}
// 		monitorInfo.StopFlag = true
// 	}
// 	return nil
// }
...
// 							productInfo := baseMonitor.GetMonitorInfo().InStock[randomNumber]
// 							baseTask.FillProductInfo(productInfo)
// 						}
// 					}
// 				}
// 			}
...
// 		Monitors: make(map[string]*base.Monitor),
// 		EventBus: eventBus,
// 	}

// 	go monitorStore.CheckMonitorStock()

// }

// // GetMonitorStatus returns the status of the given TaskGroup's monitor
// func GetMonitorStatus(groupID string) string {
// 	if baseMonitor, ok := monitorStore.Monitors[groupID]; ok {
// 		return baseMonitor.GetMonitorInfo().TaskGroup.MonitorStatus
// 	}
