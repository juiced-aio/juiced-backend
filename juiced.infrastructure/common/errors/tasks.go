...
// ParseDeleteTaskGroupsRequestError is the error encountered when parsing JSON into a DeleteTaskGroupsRequest object returns an error
const ParseDeleteTaskGroupsRequestError = "Parsing the JSON into a DeleteTaskGroupsRequest returned an error: "
