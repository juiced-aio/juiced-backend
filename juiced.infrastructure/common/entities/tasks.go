...
type Task struct {
	...
	BigCartelTaskInfo *BigCartelTaskInfo `json:"bigcartelTaskInfo,omitempty"`
...
type BigCartelTaskInfo struct {
	TaskID            string                  `json:"taskID" db:"taskID"`
	TaskGroupID       string                  `json:"taskGroupID" db:"taskGroupID"`
	CouponCode        string                  `json:"couponCode" db:"couponCode"`
	SiteURL           string                  `json:"siteURL" db:"siteURL"`
	SitePassword      string                  `json:"sitePassword" db:"sitePassword"`
	BigCartelRetailer enums.BigCartelRetailer `json:"bigcartelRetailer" db:"bigcartelRetailer"`
}
...
type TaskGroupWithTasks struct {
	...
	BigCartelMonitorInfo *BigCartelMonitorInfo `json:"bigcartelMonitorInfo,omitempty"`
...
type BigCartelMonitorInfo struct {
	ID           string                       `json:"ID" db:"ID"`
	TaskGroupID  string                       `json:"taskGroupID" db:"taskGroupID"`
	SiteURL      string                       `json:"siteURL" db:"siteURL"`
	SitePassword string                       `json:"sitePassword" db:"sitePassword"`
	Monitors     []BigCartelSingleMonitorInfo `json:"monitors"`
}
